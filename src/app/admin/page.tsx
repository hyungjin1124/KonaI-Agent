...
export default function AdminPage() {
  ...
  return (
    <ErrorBoundary>
      <Suspense fallback={<div role="status" aria-label="관리자 페이지 로딩 중..." className="flex-1 flex items-center justify-center h-full"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600" /></div>}>
        <AdminView />
      </Suspense>
    </ErrorBoundary>
  );
