---
type: raw-research
topic_id: 01-dashboard-ia-research
topic_name: 엔터프라이즈 AI 에이전트 플랫폼 대시보드/인사이트 IA 심층 분석 (원본)
category: agent-ui
document_level: raw
...
auto_update:
  enabled: false
note: |
  원본 출처: docs/research/ux-patterns/01-dashboard.md (KonaI-Agent repo, C1 파일럿 이관 전).
  7개 제품 × 8개 조사항목 매트릭스 형태의 cross-product raw research.
  Layer 2 synthesis는 [[home-dashboard-liveboard-ia-patterns]] 참조.
  본 문서는 원본 무손실 보관을 위한 raw layer이며, 신규 내용 추가는 금지.
  프론트매터를 제외한 본문은 원본과 1:1 동일.
---
